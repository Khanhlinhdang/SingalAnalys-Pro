# Create enhanced signal processor with channel coding integration
...
with open('enhanced_signal_processor.py', 'w', encoding='utf-8') as f:
    f.write(enhanced_processor_code)

print("✅ Created enhanced_signal_processor.py")
print("🧠 Enhanced Signal Processor features:")
print("  • Channel Coding Detection: Automatic FEC type identification")
print("  • Comprehensive Decoding: All major FEC algorithms integrated")
print("  • SNR Estimation: Adaptive parameter adjustment") 
print("  • Test Signal Generation: Various coded signal types")
print("  • Complete Analysis Pipeline: From IQ to decoded information")
print("  • Error Correction Metrics: Success rates and iterations")